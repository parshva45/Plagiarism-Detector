...
public class FormatUtilities {
	...
	/**
	 * Converts German non-ASCII characters to ASCII. (&szlig;&rarr;ss, &uuml;&rarr;ue, etc.)
	 * 
	 * @param s
	 * @return
	 */
	public static String spellOutGerman(String s) {
	...
	/**
	 * Converts Italina non-ASCII characters to ASCII. (&egrave;&rarr;e',&ograve;&rarr;o', etc.)
	 * 
	 * @param s
	 * @return
	 */
	public static String spellOutItalian(String s) {
		StringBuffer sb = new StringBuffer();
		for (int i = 0; i < s.length(); i++) {
			switch (s.charAt(i)) {
			case 'è': 
	...
	public static void main(String[] args) {
		System.out.println(spellOutItalian(args[0]));
	}
}
