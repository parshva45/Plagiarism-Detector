...
import edu.northeastern.cs5500.strategies.implementations.ast.treeeditdistance.tree.FixedLengthHash;
import edu.northeastern.cs5500.strategies.implementations.ast.treeeditdistance.tree.HashValue;

import javax.swing.tree.DefaultMutableTreeNode;
import javax.swing.tree.TreeNode;

import edu.northeastern.cs5500.strategies.implementations.ast.treeeditdistance.tree.FormatUtilities;
...
public class LblTree extends DefaultMutableTreeNode implements Comparable {
	...
	public String toLatex() {
		String res = "";
//		String label = util.FormatUtilities.escapeLatex(this.showNode());
	...
	public static void main(String[] args) {
		...
		System.out.println("granchild: " + granchild);
		t.insert(granchild, 0);
		System.out.println("Inserting granchild to parent...");
		System.out.println("parent: " + t);
		System.out.println("child: " + child);
		System.out.println("granchild: " + granchild);
