...
public class StudentHomeworkServiceTest {
	...
	public void testStudentHomeworkGetListOfHomeWorksByCourseIdAndHomeWorkId() {
		...
		Mockito.when(studentHomeWorkRepository.findAllByCourseIdAndAndHomeWorkId(1,1))
		...
		Mockito.verify(studentHomeWorkRepository, Mockito.times(1)).findAllByCourseIdAndAndHomeWorkId(1,1);
	...
	public void testStudentHomeworkGetListOfHomeWorksByStudentId() {
		...
		Mockito.when(studentHomeWorkRepository.findAllByUserId(1)).thenReturn(studentHomeworkList3);
		
		List<StudentHomeWork> studentHomeworkList4 = studentHomeWorkService.getListOfHomeWorksByStudentId(1);
		Mockito.verify(studentHomeWorkRepository, Mockito.times(1)).findAllByUserId(1);
	...
	public void testStudentHomeworkGetHomeWorkByStudentIdCourseIdAndHomeWorkId() {
		...
		Mockito.when(studentHomeWorkRepository.findByUserIdAndAndCourseIdAndHomeWorkId(2,1,1)).thenReturn(studentHomeworkList5);
		
		List<StudentHomeWork> studentHomeworkList6 = studentHomeWorkService.getHomeWorkByStudentIdCourseIdAndHomeWorkId(2,1,1);
		Mockito.verify(studentHomeWorkRepository, Mockito.times(1)).findByUserIdAndAndCourseIdAndHomeWorkId(2,1,1);
	...
	public void testStudentHomeworkGetHomeWorkByStudentIdCourseIdAndHomeWorkIdForNullHomeworkId() {
		...
		Mockito.when(studentHomeWorkRepository.findByUserIdAndAndCourseIdAndHomeWorkId(3,5,8)).thenReturn(null);
